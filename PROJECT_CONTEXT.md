...
- **Steps**: editable manual daily total (repeated saves replace the day), optimistic UI save; step target is saved with the user's goal and falls back to `DAILY_STEP_TARGET`
